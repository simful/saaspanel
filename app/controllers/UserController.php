...
class UserController extends BaseController {
	...
	{
		if (Auth::user()->password == Input::get('oldpassword'))
		{
			if (Input::get('newpassword') === Input::get('verifynew'))
			{
				DB::table('users')
			...
			{
				return Redirect::back()
					->with('message', 'Your new password does not match. Please try again.');
			}
		}
		else
		{
			return Redirect::back()
				->with('message', 'Old password is not match. Please try again.');
		}
	}

	public function updateNewsletterSettings()
	{
